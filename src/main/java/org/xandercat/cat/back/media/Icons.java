...
/**
 * Icons contains the icons used throughout the Cat application.
 * 
...
//	public static final ImageIcon FIND_ICON = new ImageIcon(Icons.class.getResource("icon/Find-16x16.png"));
...
//	public static final ImageIcon CHECKED_ICON = new ImageIcon(Icons.class.getResource("icon/accept-icon-16x16.png"));
	...
	public static final ImageIcon QUESTION_ICON = new ImageIcon(Icons.class.getResource("icon/help-16x16.png"));
}
